...
*/
function IWqv_userapi_getskins($args)
{
...
*/
function IWqv_userapi_getlangs($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
...
*/
function IWqv_userapi_getmaxdelivers($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
...
*/
function IWqv_userapi_gettargets($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
...
*/
function IWqv_userapi_getall($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Get the parameters
...
/*
	    ...
	    $pntables = DBUtil::getTables();
    	$qcolumn   = $pntables['IWqv_column'];
	    $acolumn   = $pntables['IWqv_assignments_column'];
		
		$joinInfo[] = array ('join_table'         =>  'IWqv_assignments',
	    ...
	    $items = DBUtil::selectExpandedObjectArray ('IWqv', $joinInfo, $where, $qcolumn['title'], -1, -1, 'qvid');
*/	    
	}else{
		$where = " ";
		$orderby = "$c[title] asc";
...
*/
function IWqv_userapi_get($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Get the parameters
 ...
 * @return	An array with the qv activity information
*/
function IWqv_userapi_completeqvinfo($args){
	extract($args);
	$sv = ModUtil::func('IWmain', 'user', 'genSecurityValue');
...
*/
function IWqv_userapi_getassignment($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Get the parameters
	extract($args);
...
*/
function IWqv_userapi_getassignmentusers($args)
{
	// Get the parameters
...
*/
function IWqv_userapi_getteacherassignments($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_ADD)) {
...
*/
function IWqv_userapi_createassignment($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_READ)) {
...
*/
function IWqv_userapi_updateassignment($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_ADD)) {
...
*/
function IWqv_userapi_getfullurl($args)
{	
	// Get the parameters
	extract($args);
 ...
 * @return	identity of the new record created or false if error
*/
function IWqv_userapi_createqv($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission('IWqv::', "::", ACCESS_ADD)) {
 ...
 */
function IWqv_userapi_deleteqv($args)
{
    $dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission('IWqv::', '::', ACCESS_ADD)) {
 ...
 * @return bool true on success, false on failure
 */
function IWqv_userapi_deleteuserassignment($args)
{
    $dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission('IWqv::', '::', ACCESS_ADD)) {
 ...
 * @return bool true on success, false on failure
 */
function IWqv_userapi_deletesection($args)
{
    $dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission('IWqv::', '::', ACCESS_ADD)) {
 ...
 * @return bool true on success, false on failure
 */
function IWqv_userapi_deletemessage($args)
{
    $dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission('IWqv::', '::', ACCESS_ADD)) {
...
*/
function IWqv_userapi_getqvassignments($args)
{
	$dom = ZLanguage::getModuleDomain('IWqv');
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_ADD)) {
...
*/
function IWqv_userapi_getsections($args)
{
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_READ)) {
		return LogUtil::registerPermissionError();
...
*/
function IWqv_userapi_getsection($args)
{
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_READ)) {
		return LogUtil::registerPermissionError();
...
*/
function IWqv_userapi_getmessage($args)
{
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_READ)) {
		return LogUtil::registerPermissionError();
...
*/
function IWqv_userapi_getsectionmessages($args)
{
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_READ)) {
		return LogUtil::registerPermissionError();
...
*/
function IWqv_userapi_processbean($args)
{
	// Get the parameters
	extract($args);
...
*/
function IWqv_userapi_beangetsections($args)
{
	// Get the parameters
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beangetsection($args)
{
	// Get the parameters
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beansavesection($args)
{
	// Get the parameters
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beansavesectionteacher($args)
{	
	// Security check
	if (!SecurityUtil::checkPermission( 'IWqv::', '::', ACCESS_ADD)) {
		return LogUtil::registerPermissionError();
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beandeliversection($args)
{
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beancorrectsection($args)
{
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beansavetime($args)
{
	// Get the parameters
	extract($args);
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beangetmessages($args)
{
	extract($args);
	if (!($assignment = DBUtil::selectObjectByID('IWqv_assignments', $assignmentid, 'qvaid'))){
		$error = "error_assignmentid_does_not_exist";
 ...
 * @return	XML with the result of the callback
*/
function IWqv_userapi_beanaddmessage($args)
{
	extract($args);
	if (!($assignment = DBUtil::selectObjectByID('IWqv_assignments', $assignmentid, 'qvaid'))){
		$error = "error_assignmentid_does_not_exist";
...
*/
function IWqv_userapi_checkmaxdelivernotexceeded($args){
	extract($args);
...
*/
function IWqv_userapi_beangetparam($args)
{
	extract($args);
 ...
 * @return	Value of the specified param
*/
function IWqv_userapi_beangetcontent($args)
{
	extract($args);
...
*/
function IWqv_userapi_addtime($args){
	extract($args);
