...
function iwqvShowAssignment(qvid, viewas){
	var action="index.php?module=iw_qv&func=show_assignment&qvid="+qvid+"&viewas="+viewas;
	document.location=action;
	return true;	
}

function iwqvEditAssignment(qvid){
	var action="index.php?module=iw_qv&func=assignment_form&qvid="+qvid;
	document.location=action;
	return true;	
}

function iwqvEditUserAssignment(userid, qvid){
	var action="index.php?module=iw_qv&func=user_assignment_form&userid="+userid+"&qvid="+qvid;
	document.location=action;
	return true;	
}
...
function iwqvDeleteUserAssignment(qvaid){
	var pars = 'module=iw_qv&func=deleteuserassignment&qvaid=' + qvaid;
...
function iwqvDeleteAssignment(qvid){
	...
	if(resp){
		var pars = 'module=iw_qv&func=deleteqv&qvid=' + qvid;
		var myAjax = new Ajax.Request(
			document.location.pnbaseURL+'ajax.php', 
			{
				method: 'post', 
...
function iwqvDeleteAssignment_init(req) 
{
	...
	//document.location='index.php?module=iw_qv&func=show_assignments_to_correct';
    return;
}
